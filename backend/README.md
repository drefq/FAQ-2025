...
Пользователь может активировать один промокод несколько раз, если это позволяет антифрод-сервис.
...
Не забудьте проверить, что компания может получить статистику только по собственный промокодам.
